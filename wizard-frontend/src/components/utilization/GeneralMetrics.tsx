...
export const GeneralMetrics = ({ generalData, ciData }: GeneralMetricsProps) => {
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2">
      ...
      <Card className="bg-gradient-card border-border/50">
        ...
        <CardContent className="pt-0">
          ...
          {ciData.maxConcurrentCISessions === 0 && (
            <a 
      ...
      <Card className="bg-gradient-card border-border/50">
        ...
        <CardContent className="pt-0">
          <div className="bg-muted/30 rounded-lg p-2 mb-1 text-center">
            <div className="text-2xl font-bold">{formatTimeSaved(generalData.totalSessionTime)}</div>
          </div>
          <div className="text-xs text-muted-foreground text-center">
