                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mb-4">
                        ...
                        target's traffic. You can do this by specifying a filter
                        on either an HTTP header or path.
                      </p>
                    </div>
                              ...
                              <Button
                                ...
                                onClick={() => {
                                  ...
                                  const updated = updateConfigFilter(
                                    {
                                      headerFilters: existingH.concat([
                                        "header",
                                      ]),
                    ...
                    <div className="space-y-4 mt-6">
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground mb-3">
                          ...
                          remote port (other ports will remain local). Deselect
                          any ports that are not HTTP or gRPC. The following
                          ports were detected in your target, with some already
