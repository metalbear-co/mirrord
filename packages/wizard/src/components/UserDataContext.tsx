...
export const UserDataContext = React.createContext<boolean | undefined>(undefined)
...
export const ConfigDataContext = React.createContext<ConfigData | undefined>(undefined)

export const useConfigData = (): ConfigData => {
  const context = useContext(ConfigDataContext)
  if (!context) {
    throw new Error('useConfigData must be used within a ConfigDataContextProvider')
  }
  return context
}
