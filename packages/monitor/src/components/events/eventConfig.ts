...
> = {
  ...
  [EventType.DnsQuery]: {
    variant: 'outline',
    label: strings.events.labels.dns,
    className: NEUTRAL_BADGE,
    icon: Globe,
  },
  [EventType.IncomingRequest]: {
    variant: 'outline',
    label: strings.events.labels.http,
    className: NEUTRAL_BADGE,
    icon: Zap,
  },
...
export const FILTER_CHIPS: {
  ...
  {
    type: null,
    label: strings.events.all,
    colorClass: CHIP_INACTIVE,
    activeClass: CHIP_ACTIVE,
  },
  {
    type: EventType.IncomingRequest,
    label: strings.events.incoming,
    colorClass: CHIP_INACTIVE,
    activeClass: CHIP_ACTIVE,
  },
  {
    type: EventType.DnsQuery,
    label: strings.events.dns,
    colorClass: CHIP_INACTIVE,
    activeClass: CHIP_ACTIVE,
  },
  {
    type: EventType.FileOp,
    label: strings.events.fileOps,
    colorClass: CHIP_INACTIVE,
    activeClass: CHIP_ACTIVE,
  },
  {
    type: EventType.OutgoingConnection,
    label: strings.events.outgoing,
    colorClass: CHIP_INACTIVE,
    activeClass: CHIP_ACTIVE,
  },
]
