export const strings = {
  ...
  map: {
    ...
    viewMap: 'Map',
    legendTitle: 'Legend',
    legendEntry: 'Entry / Client',
    legendCore: 'Core services',
    legendData: 'Data services',
    legendQueue: 'Queues & streams',
    legendDev: 'Developer session',
    kindService: 'Service',
    kindData: 'Data store',
    kindQueue: 'Queue / Stream',
    kindEntry: 'Entry point',
    kindInfra: 'Infrastructure',
    discovered: 'Observed via DNS',
    ...
    emptyBody:
      'Start a mirrord session and the map builds itself: targets, teammates, and the services your process talks to appear here as they are discovered.',
  },
  events: {
