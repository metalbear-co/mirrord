...
- CI was split from a large monolithic `.github/workflows/ci.yaml` into reusable workflow files like `.github/workflows/check-lint.yaml`, `.github/workflows/test-integration.yaml`,
    `.github/workflows/test-macos.yaml`, `.github/workflows/test-windows.yaml`, plus composite actions under `.github/actions/build-mirrord-cli/action.yml`.
