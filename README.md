...
the process runs wherever you launch it, on your machine, a CI runner, or a cloud agent's environment, while mirrord routes its traffic, files, and environment variables through the cluster so it behaves as if it were running inside it.
