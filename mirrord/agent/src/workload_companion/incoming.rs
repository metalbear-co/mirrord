...
/// Sender used to inject bridged connections into the agent incoming pipeline.
#[derive(Clone, Debug)]
...
/// [`PortRedirector`] implementation that receives redirected connections from the remote-layer
