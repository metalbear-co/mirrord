...
#[derive(Encode, Decode, Debug, PartialEq, Eq, Clone, Deref, Display, Hash)]
...
#[derive(Encode, Decode, Debug, PartialEq, Eq, Clone, Deref, Hash)]
...
#[derive(Debug, Clone, Deref, PartialEq, Eq, Encode, Decode, Display, Hash)]
...
/// string.
#[derive(
    Encode, Decode, Debug, PartialEq, Eq, Clone, EnumString, strum_macros::Display, AsRefStr, Hash,
)]
...
#[derive(Encode, Decode, Debug, PartialEq, Eq, Clone, strum_macros::Display, Hash)]
