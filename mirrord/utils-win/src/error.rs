//! Windows error type and formatting helpers.
//!
//! This is the relocated home for [`WindowsError`]. It used to live in `mirrord-layer-lib`.
//! That crate now re-exports it from here.
