...
struct Reachability {
    ...
    ///
    /// [`NewOperatorFeature::SubscribeEventOptions`]: mirrord_operator::crd::NewOperatorFeature::SubscribeEventOptions
    supported: bool,
...
impl Reachability {
    fn of(operator: &Result<OperatorStatusSummary, String>) -> Self {
        match operator {
            Ok(operator) => Self {
                available: true,
                supported: operator.supports_subscribe_event_options,
