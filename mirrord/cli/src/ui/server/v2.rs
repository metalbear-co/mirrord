...
struct OperatorStatusSummary {
    ...
    /// Whether this operator can name and pair the events the events view reads.
    supports_subscribe_event_options: bool,
...
async fn fetch_operator(
    ...
    Ok(OperatorStatusSummary {
        ...
        preview_sessions,
        license,
        supports_subscribe_event_options: supported_features
