...
impl KubernetesAPI {
        ...
        P: Progress + Send + Sync,
    {
        ...
        {
            progress.warning("mirrord is running on openshift, due to default PSP of openshift, mirrord may not be able to create the agent. Please refer to https://mirrord.dev/docs/overview/faq/");
        };
        Ok(())
    }
}
