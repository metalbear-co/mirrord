...
pub enum MariadbBranchCopyConfig {
    Empty {
        tables: Option<BTreeMap<String, MariadbBranchTableCopyConfig>>,
        #[serde(default, skip_serializing_if = "Option::is_none")]
...
impl Default for MariadbBranchCopyConfig {
    fn default() -> Self {
        MariadbBranchCopyConfig::Empty {
...
pub type MariadbBranchTableCopyConfig = super::BranchItemCopyConfig;
