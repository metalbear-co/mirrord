...
/// The default number of seconds allowed for each agent request made while prefetching.
/// See [`FsConfig::prefetch_timeout`].
pub const PREFETCH_TIMEOUT_DEFAULT: u64 = 30;
...
pub struct FsConfig {
    ...
    /// usual.
    #[config(default = PREFETCH_TIMEOUT_DEFAULT)]
