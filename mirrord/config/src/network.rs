...
mod tests {
    ...
    fn default(
        #[values(
            (None, IncomingConfig { mode: IncomingMode::Mirror, http_header_filter: None}),
            (Some("false"), IncomingConfig { mode: IncomingMode::Mirror, http_header_filter: None}),
            (Some("true"), IncomingConfig { mode: IncomingMode::Steal, http_header_filter: None}),
        )]
