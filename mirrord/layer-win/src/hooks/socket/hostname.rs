...
use winapi::{
    um::winsock2::{SOCK_STREAM, SOCK_DGRAM},
    shared::{
        minwindef::INT,
...
use super::utils::{intelligent_truncate, validate_buffer_params, evict_old_cache_entries};
    ...
    F: Fn(*mut i8, *mut u32) -> i32,
{
    ...
    if let Some(buffer_size) = validate_buffer_params(lpBuffer as *mut u8, nSize, REASONABLE_BUFFER_LIMIT) {
