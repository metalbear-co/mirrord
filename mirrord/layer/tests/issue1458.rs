...
async fn test_issue1458(
    ...
    test_process.assert_stdout_contains("test issue 1458: START").await;
    test_process.assert_stdout_contains("test issue 1458: SUCCESS").await;
}
...
async fn test_issue1458_port_not_53(
    ...
    test_process.wait_assert_success().await;
    test_process.assert_stdout_contains("test issue 1458 port not 53: START").await;
    test_process.assert_stdout_contains("test issue 1458 port not 53: SUCCESS").await;
}
