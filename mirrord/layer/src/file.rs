...
use crate::{
    common::{ManagedResource, ManagedResourceHashmap, ResponseChannel, ResponseDeque},
...
type ManagedFile = ManagedResource<usize>;

pub(crate) static OPEN_FILES: LazyLock<Mutex<ManagedResourceHashmap<usize>>> =
