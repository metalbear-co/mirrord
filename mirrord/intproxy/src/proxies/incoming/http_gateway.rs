...
//     /// Runs a [`hyper`] server that accepts only requests upgrading to the [`TEST_PROTO`]
// protocol.     async fn dummy_echo_server(
...
//         let client_store =
//             ClientStore::new_with_timeout(Duration::from_secs(1337 * 21 * 37),
// Default::default());         let _gateway_1 = tasks.register(
//             HttpGatewayTask::new(
//                 request.clone(),
//                 client_store.clone(),
//                 Some(ResponseMode::Basic),
