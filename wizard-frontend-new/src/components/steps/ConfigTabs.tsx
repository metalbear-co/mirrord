...
import { Copy, FileJson, Download, Check, Terminal, Code2, FolderOpen } from "lucide-react";
        ...
        {currentTab === "export" && (
          <div className="space-y-5">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Button variant="outline" size="sm" onClick={downloadConfig} className="gap-2">
              ...
              <div className="grid gap-2">
                <div className="flex items-start gap-3 p-3 rounded-lg bg-[var(--muted)]/30 border border-[var(--border)]">
                  ...
                  <div className="text-sm">
                    <span className="font-medium text-[var(--foreground)]">CLI: </span>
                ...
                <div className="flex items-start gap-3 p-3 rounded-lg bg-[var(--muted)]/30 border border-[var(--border)]">
                  ...
                  <div className="text-sm">
                    <span className="font-medium text-[var(--foreground)]">IDE: </span>
                    <span className="text-[var(--muted-foreground)]">
                      Save as{" "}
                      <code className="px-1.5 py-0.5 bg-[var(--muted)] rounded text-xs font-semibold">
