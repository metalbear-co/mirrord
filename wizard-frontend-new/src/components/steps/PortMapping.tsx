    ...
    <div className="border border-[var(--border)] rounded-lg p-3 space-y-3">
      <div className="flex items-center gap-3">
        <div className="flex-1 font-mono">
          <p className="flex h-10 w-full rounded-md border border-[var(--border)] bg-[var(--background)] px-3 py-2 text-base ring-offset-background md:text-sm">
            {remotePort}
          </p>
        </div>

        <ArrowRight className="h-4 w-4 text-[var(--muted-foreground)] flex-shrink-0" />
