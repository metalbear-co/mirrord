...
describe('BoilerplateStep', () => {
  ...
  it('displays descriptive text for each mode', () => {
    ...
    expect(screen.getByText(/Selectively intercept traffic based on HTTP headers/)).toBeInTheDocument();
  ...
  it('renders the heading text', () => {
    ...
    expect(screen.getByText('Choose a mode that fits your development workflow')).toBeInTheDocument();
  });
});
