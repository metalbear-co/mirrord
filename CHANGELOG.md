...
## [3.41.0](https://github.com/metalbear-co/mirrord/tree/3.41.0) - 2023-05-05
...
- Add x-session-id to operator request, that is persistent across child
  ...
  [#operator-session-id](https://github.com/metalbear-co/mirrord/issues/operator-session-id)
