...
## [3.135.0](https://github.com/metalbear-co/mirrord/tree/3.135.0) - 2025-03-17


### Added

- mirrord now issues a warning when the config allows for stealing health
  checks from the target.
...
- Pinned `ziglang` version to `0.13.0.post1` in the CI due to compilation
  failure.
- Updated every schema that is used in our crds to use a k8s style
  namespacing for schema names for better compliance with openapi.
- Updated some dependencies.
- Switched to our own forked changed-files GitHub Action.
