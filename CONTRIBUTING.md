...
The `mirrord-agent` feature-gates dependencies, modules and it's entrypoint to allow compilation on MacOS, but produces a binary that does nothing.
...
2. Get a C compiler capable of targetting the `x86_64-unknown-linux-gnu` triplet
